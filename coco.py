'''
Modified version of https://github.com/dbolya/yolact/blob/master/data/coco.py

The following line was written to check prevent an error : `if hasattr(target, 'shape') and target.shape[0] == 0:`
'''
